      ...
      >
        <div className="relative">
          <video
            ...
            poster={msg.thumbnail || "https://via.placeholder.com/300x200.png?text=Video+Preview"}
            controls={isPlaying}
            onClick={handlePlay}
            onError={(e) => (e.target.poster = "https://via.placeholder.com/300x200.png?text=Error")}
            loading="lazy"
          >
